<div class="role-matches-wrapper role-matches-talent-view-wrapper">
	<div class="talents-search-filter-content">
		...
		<div class="row-fluid clearfix">
			...
			<div id="role-match" class="col-md-12 talents-search-result">
				...
				<div class="row-fluid clearfix" id="role-match-result">
					@include('components.talent', [ 'databind' => [ 'template' => '#role-match-result', 'value' => 'role.matches.data' ], 'class' => 'col-lg-3 col-md-6 col-sm-6 col-xs-12' , 'favorites' => true , 'favorites_notes' => true])
				</div>
