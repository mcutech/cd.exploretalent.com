@extends('layouts.project', ['pages' => [ [ 'name' => 'My Projects', 'url' => '/projects' ], [ 'name' => 'Edit Project', 'url' => '/projects/12345/edit', 'active' => true ] ] ])
					...
					<div class="row-fluid">
						<div class="col-md-12">
							<div class="pull-right">
								<a href="#" id="create-project-btn" class="btn btn-success btn-lg">Update</a>
							</div>
						</div>
					</div>
				</div> {{-- container-fluid --}}
