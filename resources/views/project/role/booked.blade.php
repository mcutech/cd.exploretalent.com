...
<i class="fa fa-th-list page-header-icon"></i> Booked - <b data-bind="<%= name + ' ' + '(' + casting_id + ')' %>"></b>
@stop
...
<div class="row">
	<div class="col-md-12 padding-bottom-medium hide" id="no-booked">
		<span class="alert alert-success display-block">
