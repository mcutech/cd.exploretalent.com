@extends('layouts.role', [ 'active' => 'submissions', 'pages' => [ [ 'name' => 'My Projects', 'url' => '/projects' ], [ 'name' => 'Submissions', 'url' => './submissions', 'active' => true ] ] ])

@section('sidebar.page-header')
<i class="fa fa-th-list page-header-icon"></i> Submissions
@stop
