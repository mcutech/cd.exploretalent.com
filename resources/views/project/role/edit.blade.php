@extends('layouts.sidebar', [ 'pages' => [ [ 'name' => 'Roles', 'url' => '/settings' ], [ 'name' => 'Edit Role', 'url' => '/projects/123/roles/123/edit', 'active' => true] ] ])
...
<div class="row-fluid clearfix">
	<div class="col-md-12">
		<div class="form-group margin-top-medium">
			...
			<button class="btn btn-primary margin-left-small" type="submit">Save</button>
