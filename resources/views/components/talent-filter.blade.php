		...
		<div class="panel-body">
			<div>
				<div class="panel panel-transparent margin-bottom-normal input-group">
					...
					<span id="search-talent-btn" class="input-group-addon padding-left-large padding-right-large" style="cursor: pointer;">
			            <span class="glyphicon glyphicon-search"></span>
			        </span>
				</div>

				<div class="panel panel-transparent margin-bottom-normal-medium">
					<div class="panel-heading no-padding-hr padding-bottom-zero-small padding-top-zero">
						<div class="panel-title text-uppercase"><a href="#location-panel" class="" data-toggle="collapse" ><strong><i class="fa fa-map-marker"></i> Location</strong></a></div>
					</div>
					<div id="location-panel" class="panel-collapse collapse in">
						...
						<div class="panel-body padding-small hide-if-nationwide">
							<div class="tab-content no-padding-hr padding-top-zero-zz-lg no-padding-b">
								<div class="tab-pane fade active in">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="input-group col-md-12">
												<select id="markets-list" class="form-control">
													<option></option>
									...
									<div class="row margin-top-small" id="markets">
										<label class="checkbox-inline margin-right-small" data-bind-template="#markets" data-bind-value="markets">
											<input type="checkbox" name="markets" class="market-item px" data-bind="<%= name %>" data-bind-target="value" value="" checked>
				...
				<div class="panel panel-transparent margin-bottom-normal-medium">
					<div class="panel-heading no-padding-hr padding-bottom-zero-small padding-top-zero">
						<div class="panel-title text-uppercase"><a href="#appearance-panel" class="" data-toggle="collapse"><strong><i class="fa fa-user"></i> Appearance</strong></a></div>
					</div>
					<div id="appearance-panel" class="panel-collapse collapse in">
						<div class="panel-body padding-small">
							<div class="row-fluid clearfix">
								<div class="col-md-6 panel-body padding-small no-border-hr no-padding-hr">
									<div class="tab-content no-padding-hr padding-top-zero-zz-lg no-padding-b">
										<div class="tab-pane fade active in">
											...
											<div class="panel margin-bottom-zero-small margin-right-normal">
												<div class="padding-small padding-left-normal padding-right-normal">
								...
								<div class="col-md-6 panel-body padding-small no-border-hr no-padding-hr">
									<div class="tab-content no-padding-hr padding-top-zero-zz-lg no-padding-b">
										<div class="tab-pane fade active in">
											...
											<div class="panel margin-bottom-zero-small">
												<div class="padding-small padding-left-normal padding-right-normal">
									...
									<div class="tab-pane fade active in">
										...
										<div class="row">
											<div class="body-type-checkbox">
												<label class="checkbox-inline margin-right-small display-none">
													<input type="checkbox" name="" value="" class="px" data-bind=""> <span class="lbl"></span>
												</label>
									...
									<div class="tab-pane fade active in">
										...
										<div class="row">
											<div class="ethnnicity-checkbox">
												...
												<label class="checkbox-inline margin-right-small">
													<input type="checkbox" name="ethnicity" value="American" class="px" data-bind="<%= role.getEthnicities().indexOf('American') != -1 ? 1 : 0 %>"> <span class="lbl">American</span>
												</label>
												<label class="checkbox-inline margin-right-small">
												...
												<label class="checkbox-inline margin-right-small">
													<input type="checkbox" name="ethnicity" value="Caribbean" class="px" data-bind="<%= role.getEthnicities().indexOf('Caribbean') != -1 ? 1 : 0 %>"> <span class="lbl">Caribbean</span>
												</label>
												<label class="checkbox-inline margin-right-small">
												...
												<label class="checkbox-inline margin-right-small">
													<input type="checkbox" name="ethnicity" value="East Indian" class="px" data-bind="<%= role.getEthnicities().indexOf('East Indian') != -1 ? 1 : 0 %>"> <span class="lbl">East Indian</span>
												</label>
												<label class="checkbox-inline margin-right-small">
												...
												<label class="checkbox-inline margin-right-small">
													<input type="checkbox" name="ethnicity" value="Mediterranean" class="px" data-bind="<%= role.getEthnicities().indexOf('Mediterranean') != -1 ? 1 : 0 %>"> <span class="lbl">Mediterranean</span>
												</label>
												<label class="checkbox-inline margin-right-small">
												...
												<label class="checkbox-inline margin-right-small">
													<input type="checkbox" name="ethnicity" value="Mixed" class="px" data-bind="<%= role.getEthnicities().indexOf('Mixed') != -1 ? 1 : 0 %>"> <span class="lbl">Mixed</span>
												</label>
											</div>
										</div>
									</div>
				...
				<div class="panel panel-transparent no-margin-b margin-top-normal">
					<div class="panel-heading no-padding-hr padding-bottom-zero-small padding-top-zero">
						<div class="panel-title text-uppercase"><a href="#membership-panel" class="" data-toggle="collapse"><strong><i class="fa fa-star"></i> Membership</strong></a></div>
					</div>

					<div id="membership-panel" class="panel-collapse collapse in">
						<div class="panel-body padding-small">
							<div class="tab-content no-padding-hr padding-top-zero-zz-lg no-padding-b">
								<div class="tab-pane fade active in">
									<div class="row">
				...
				<div class="row-fluid clearfix margin-top-normal">
					<div class="col-md-12 padding-zero">
						<button id="talent-filter-button" type="button" class="btn btn-success btn-block btn-lg">Search</button>
					</div> <!-- SEARCH BTN -->
				</div>
