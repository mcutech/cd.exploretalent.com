...
<div class="row-fluid clearfix">
	<div class="col-md-12" >
		<div id="talent-resume-info" class="col-md-12">
			<div class="col-md-6">
				<h3 class="">
		...
		<div class="col-md-3">
			<div id="talent-primary-photo" class="col-md-12">
				<img data-bind="<%= getPrimaryPhoto() %>" class="margin-top-large" width="100%">
			</div>
			<div class="col-md-12">
				<div id="first-photo" class="col-md-6 padding-right-zero padding-left-zero">
					<img data-bind="https://etdownload.s3.amazonaws.com/<%= bam_media_path_full %>" class="margin-top-small" width="100%">
				</div>
				<div id="second-photo" class="col-md-6 padding-right-zero padding-left-zero">
					<img data-bind="https://etdownload.s3.amazonaws.com/<%= bam_media_path_full %>" class="margin-top-small" width="100%">
				</div>
			</div>
			<div id="third-photo" class="col-md-12">
				<img data-bind="https://etdownload.s3.amazonaws.com/<%= bam_media_path_full %>" class="margin-top-small" width="100%">
			</div>
			<div class="col-md-12">
			...
			<div class="col-md-9">
				...
				<div id="acting-modeling" class="col-md-12">
					...
					<div class="row margin-top-medium">
						<div data-bind="<%= (heightText()) ? 1 : 0 %>" data-bind-target="visibility">
						...
						<div data-bind="<%= (bam_talentinfo2.ethnicity) ? 1 : 0 %>" data-bind-target="visibility">
							<div class="col-md-3 col-xs-3">
					...
					<div class="row">
						<div data-bind="<%= (bam_talentinfo1.weightpounds) ? 1 : 0 %>" data-bind-target="visibility">
							<div class="col-md-3 col-xs-3">
								<label>Weight</label>
							</div>
							<div class="col-md-3 col-xs-3">
						...
						<div data-bind="<%= (bam_talentinfo1.haircolor) ? 1 : 0 %>" data-bind-target="visibility">
							<div class="col-md-3 col-xs-3">
					...
					<div class="row">
						<div data-bind="<%= (bam_talentinfo1.build) ? 1 : 0 %>" data-bind-target="visibility">
							<div class="col-md-3 col-xs-3">
						...
						<div data-bind="<%= (bam_talentinfo1.eyecolor) ? 1 : 0 %>" data-bind-target="visibility">
							<div class="col-md-3 col-xs-3">
				...
				<div id="musician" class="col-md-12">
					...
					<div class="row" data-bind="<%= bam_talent_music[0].years_experience ? '1' : '' %>" data-bind-target="visibility">
						<div class="col-md-4 col-xs-3">
