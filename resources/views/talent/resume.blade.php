      ...
      <div class="row-fluid clearfix">
        <div class="col-md-4 col-sm-4 col-xs-8 margin-bottom-small-zz-xs">
          <div class="padding-top-zero-small">
            <label> <span data-bind="<%= bam_casting && bam_casting.name ? bam_casting.name : '' %>"></span></label> <label class="text-muted"> <span data-bind="<%= name ? name : '' %>"></span></label>
          </div>
        </div>
        <div class="col-md-2">
        </div>
        <div id="add-to-like-it-list-bind">
          <div class="col-md-3 col-sm-4 col-xs-4" data-bind="<%= talent.user.id + '-' + role_id + '-' + talent.talentnum %>" data-bind-target="data-id">
