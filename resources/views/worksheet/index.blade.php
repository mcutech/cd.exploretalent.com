...
<div class="audition-worksheet-list-wrapper">
	<div class="row clearfix form-horizontal margin-bottom-normal">
		...
		<div class="col-md-3 float-right">
			<a href="" class="btn btn-success btn-block"><i class="fa fa-plus"></i> Create New Schedule</a>
		</div>
	</div>
		...
		<table class="table table-striped">
			...
			<tbody id="campaigns-list">
				<tr data-bind-template="#campaigns-list" data-bind-value="data">
					<td>
						<div class="text-bold">
							<a href="/find-talents"><span data-bind="<%= bam_role.bam_casting.name + ' (#' + bam_role.bam_casting.casting_id + ')' %>"></span></a>
						</div>
					...
					<td><a href="#">2</a></td>
					<td>
						<a class="btn btn-success btn-xs" data-bind="/audition-worksheet/<%= id %>"> Manage Worksheet</a>
						<a class="btn btn-warning btn-xs" href="#">Send Times</a>
					</td>
				</tr>
			</tbody>
			<tfoot>
